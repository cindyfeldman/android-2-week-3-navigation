...
public class NotificationPagerFragment extends Fragment {
    ...
    if(adapter==null){
        ...
        return inflater.inflate(R.layout.fragment_view_pager, container, false);//makes fragment show up
        ...
        public String getTitle(int position) {
            switch (position) {
                ...
                case 1:
                    return "You";
                default:
                    throw new IllegalArgumentException("Unsupported index at: " + position);
            }
        }
    }
}
